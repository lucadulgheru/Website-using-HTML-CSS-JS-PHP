...
<body onload="showSlides()">
    ...
    <div class="topnav">
        ...
        <a href="index_loggedin.php"><img src="img/logo_transparent.png" alt="SGImag logo" height="75" width="150"></a>
          ...
          <div class="dropdown">
            ...
            <img src="img/account.PNG" alt="My account" height="30" width="30">
                ...
                <div class="dropdown-content">
                  ...
                  <a href="utils/user_logout.php">Sign OUT</a>
                  <br>
                  <p id='connecteduser'>Logged in as: </p>
